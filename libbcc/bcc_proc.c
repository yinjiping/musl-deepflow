...
int bcc_procutils_each_module(int pid, bcc_procutils_modulecb callback,
  ...
  // Modify the deepflow-agent to first parse the /tmp/perf-<PID>.map file. If
  // this file does not exist, then look for it in /proc/<PID>/root/tmp/perf-<TARGET-PID>.map.
